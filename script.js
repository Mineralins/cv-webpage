...
const translations = {
    en: {
        ...
        'about-journey-text': [
            ...
            'August - October 2023 - Personal Assistant to the CEO;',
        ...
        'projects-subtitle': 'From innovative micro-products to enterprise ecosystems',
        
        // Anima Project
        'anima-title': 'Anima: Smart Office Ecosystem Platform',
        'anima-description': 'A comprehensive microservices-based SaaS and On-premise platform transforming hybrid work environments through intelligent space management, real-time analytics, and automation.',
        'anima-feature1': 'Microservices Architecture',
        'anima-feature2': 'Multi-module System',
        'anima-feature3': 'SaaS & On-Premise',
        'anima-components': '<strong>Platform Components:</strong> Booking system • Service Desk • Social modules • Engineering systems control • Multimedia management • Mobile applications (iOS/Android) • Web app • Admin panel',
        'anima-challenge': 'Challenge',
        'anima-challenge-text': 'To develop an enterprise-grade platform that optimizes office space utilization for hybrid work models, integrating multiple engineering systems and providing data-driven insights for large corporations.',
        'anima-challenge1': '40%+ daily office space vacancy reduction challenge',
        'anima-challenge2': 'Integration of disparate systems: HVAC, lighting, access control',
        ...
        'anima-role3': '<strong>Team management:</strong> 5 core specialists + outsourced team',
        ...
        'anima-role7': '<strong>Integration coordination</strong> with corporate systems (Bitrix24, Active Directory, Microsoft Exchange, etc.)',
        'anima-role8': '<strong>Pre-sales activities:</strong> demos, negotiations, contract preparation',
        'anima-role9': '<strong>Create product monetization strategy</strong> and financial modeling',
        'anima-role10': '<strong>Compliance:</strong> Russian software registry & patent applications',
        'anima-outcome': 'Outcome',
        'anima-outcome-text': 'Successfully launched an enterprise solution:',
        'anima-outcome1': 'Achieved MVP in 7 months under tight deadlines',
        'anima-outcome2': 'Inclusion of software in the register of Russia software, which allowed for the receipt of benefits and grants',
        'anima-outcome3': 'Closed enterprise sales to major commercial companies',
        'anima-outcome4': 'Built and scaled core team from 1 to 5 key specialists',
        'anima-outcome5': 'Developed monetization strategy and financial models',
        'anima-outcome6': 'Implemented Agile methodologies (Scrum/Kanban), transforming the development process into a flexible cycle',
        ...
        'mood-challenge-text': 'Create an engaging, lightweight app for a corporate trade show to visualize visitors emotions and showcase the power of real-time data visualization using engineering systems and multimedia.',
        ...
        'mood-role2': '<strong>UI/UX:</strong> Сreated the concept of mood selection interface and real-time visualization',
        ...
        'mood-role5': '<strong>Analytics:</strong> Technical specifications for real-time mood tracking analytics and visualization',
        ...
        'competency-1': 'Team Leadership & Scaling',
        'competency-2': 'Product Roadmapping',
        'competency-3': 'Stakeholder Management',
        'competency-4': 'UX/UI Testing',
        'competency-5': 'Pre-sales & Demos',
        'competency-6': 'Cross-team Coordination',
        'competency-7': 'Agile Transformation',
        'competency-8': 'Microservices Planning',
        'competency-9': 'Budget Management',
        'competency-10': 'Risk Assessment',
        'competency-11': 'Quality Assurance',
        'competency-12': 'Backlog management',
        'competency-13': 'Competitor analysis',
        'competency-14': 'Conducting negotiations',
        'competency-15': 'Customer Journey Mapping',
        
        // Contact Section
        'contact-title': 'Let\'s Connect',
        'contact-subtitle': 'Open to opportunities (Remote or Relocation)',
        ...
        'contact-roles': 'Interested in roles: Project Manager, Delivery Manager in IT sector',
    ...
    ru: {
        ...
        'projects-subtitle': 'От инновационных микро-продуктов до корпоративных экосистем',
        
        // Anima Project
        'anima-title': 'Anima: Платформа экосистемы умного офиса',
        'anima-description': 'Комплексная SaaS и On-premise платформа на основе микросервисной архитектуры, преобразующая гибридную рабочую среду через интеллектуальное управление пространством, аналитику в реальном времени и автоматизацию.',
        'anima-feature1': 'Микросервисная архитектура',
        'anima-feature2': 'Многомодульная система',
        'anima-feature3': 'SaaS и On-Premise',
        'anima-components': '<strong>Компоненты платформы:</strong> Система бронирования • Service Desk • Социальные модули • Управление инженерными системами • Управление мультимедиа • Мобильные приложения (iOS/Android) • Веб-приложение • Админ-панель',
        'anima-challenge': 'Задача',
        'anima-challenge-text': 'Разработать корпоративную платформу, оптимизирующую использование офисного пространства для гибридных рабочих моделей, интегрирующую различные инженерные системы и предоставляющую аналитику на основе данных для крупных корпораций.',
        'anima-challenge1': 'Сокращение ежедневной простаивающей площади офиса на 40%+',
        'anima-challenge2': 'Интеграция различных систем: HVAC, освещение, контроль доступа',
        ...
        'anima-role3': '<strong>Управление командой:</strong> 5 ключевых специалистов + аутсорс-команда',
        'anima-role4': '<strong>Внедрение Agile/Scrum</strong> с использованием Jira/Bitrix24',
        'anima-role5': '<strong>Разработка технических заданий</strong> для веб/мобильного приложений',
        'anima-role6': '<strong>Тестирование UX/UI</strong> и оптимизация пользовательского опыта',
        'anima-role7': '<strong>Координация интеграций</strong> с корпоративными системами (Битрикс24, Active Directory, Microsoft Exchange и др.)',
        'anima-role8': '<strong>Пре-сейл активность:</strong> демонстрации, переговоры, подготовка контрактов',
        'anima-role9': '<strong>Создание стратегии монетизации продукта</strong> и финансовое моделирование',
        'anima-role10': '<strong>Соответствие требованиям:</strong> включение в реестр отечественного ПО и патенты',
        ...
        'anima-outcome2': 'Включение программного обеспечения в реестр отечественного ПО, дающего право на получение льгот и грантов',
        'anima-outcome3': 'Реальзованы продажи крупным корпоративным клиентам',
        'anima-outcome4': 'Создана и расширена основная команда с 1 до 5 ключевых специалистов',
        'anima-outcome5': 'Разработана стратегия монетизации и финансовые модели',
        'anima-outcome6': 'Внедрила Agile-методологии (Scrum/Kanban), преобразовав процесс разработки в гибкий цикл',
        ...
        'mood-challenge-text': 'Создать увлекательное, легкое приложение для корпоративной выставки, чтобы визуальзировать эмоции посетителей и показать возможности визуализации данных в реальном времени при помощи инженерных систем и мультимедиа.',
        ...
        'mood-role2': '<strong>UI/UX:</strong> Cоздала концепцию интерфейса выбора настроения и визуализации в реальном времени',
        ...
        'mood-role5': '<strong>Реализация аналитики:</strong> Техническое задание на аналитику отслеживания настроения и визуализации в реальном времени',
        ...
        'mood-outcome-text': 'Успешная выставочная инсталляция, которая вовлекла 500+ посетителей, предоставила аналитику настроения в реальном времени, продемонстрировала технические возможности потенциальным клиентам и принесла лиды для основной платформы Anima.',
        'mood-link1': 'Статья о выставке',
        
        // Skills Section
        'skills-title': 'Мои инструменты и навыки',
        'skills-subtitle': 'Сочетание технической экспертизы и глубокого понимания пользовательского опыта ',
        ...
        'competency-1': 'Лидерство команды и масштабирование',
        'competency-2': 'Планирование продуктовой дорожной карты',
        'competency-3': 'Управление заинтересованными сторонами',
        'competency-4': 'Тестирование UX/UI',
        'competency-5': 'Пре-сейл и демонстрации',
        'competency-6': 'Межкомандная координация',
        'competency-7': 'Agile-трансформация',
        'competency-8': 'Планирование микросервисов',
        'competency-9': 'Управление бюджетом',
        'competency-10': 'Оценка рисков',
        'competency-11': 'Обеспечение качества',
        'competency-12': 'Ведение беклога',
        'competency-13': 'Конкурентный анализ',
        'competency-14': 'Ведение переговоров',
        'competency-15': 'Планирование пользовательского опыта',


        // Contact Section
        'contact-title': 'Свяжитесь со мной',
        'contact-subtitle': 'Открыта для предложений (удаленно или переезд)',
        ...
        'contact-availability': 'Доступна для предложений',
        'contact-roles': 'Интересующие роли: Менеджер проектов, Delivery Manager в IT-секторе',
